  ...
  .maybeSingle();
    ...
    const res =
      await fetch(
        ...
        "/api/manager/hours-exception/approve",
  ...
  .maybeSingle();
    ...
    const res =
      await fetch(
        ...
        "/api/manager/hours-exception/deny",
  ...
  .maybeSingle();
    ...
    const res =
      await fetch(
        ...
        "/api/manager/hours-exception/claim",
  ...
  try {
    ...
    const res =
      await fetch(
        ...
        "/api/manager/hours-exception/complete",
  ...
  .maybeSingle();
    ...
    const res =
      await fetch(
        ...
        "/api/manager/hours-exception/escalate",
