  ...
  try {
    ...
    const res =
      await fetch(
        ...
        "/api/manager/incidents/complete",
  ...
  .maybeSingle();
    ...
    const res =
      await fetch(
        ...
        "/api/manager/incidents/escalate",
...
<AdminOverridePanel
  ...
  requestTable="incident_requests"
